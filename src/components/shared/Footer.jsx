        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-slate-400 mb-6 max-w-xl mx-auto">
              Join hundreds of organizations that trust VOCOxP for their
              security needs.
            </p>
            {/* <motion.a
                            href="#enquiry"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                >
                  <img src="/web/Images/logo-vocoxp2.png" alt="" />{" "}
                </div>
                <span
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-5">
                Trust should not be assumed—it should be verified. Protecting
                organizations worldwide with intelligent identity verification.
              </p>
            </div>
