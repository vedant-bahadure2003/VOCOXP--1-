  ...
  return (
    ...
    >
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                filter:
                  "brightness(0.8) contrast(1.2) saturate(1.1) grayscale(0.2)",
              }}
            />
            ...
            <motion.div
              ...
              style={{
                background:
                  "radial-gradient(ellipse at 50% 40%, rgba(59, 130, 246, 0.2) 0%, rgba(30, 64, 175, 0.1) 30%, transparent 70%)",
              }}
              animate={{
                opacity: [0.6, 1, 0.6],
              }}
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse at center, transparent 20%, rgba(15, 23, 42, 0.3) 100%)",
              }}
            />
          </motion.div>
        </AnimatePresence>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, rgba(15, 23, 42, 0.95) 0%, rgba(15, 23, 42, 0.6) 30%, transparent 100%)",
        }}
      />
    </section>
  );
