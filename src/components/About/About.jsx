  ...
  return (
    <section id="about" className="relative py-20 md:py-32">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, var(--color-void) 0%, #f1f5f9 50%, var(--color-void) 100%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-slate-600 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            Every day, unverified individuals walk through doors that should
            protect you. Handwritten logs, verbal entries, and photocopied IDs
